        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="flex justify-center mt-4">
            <Button 
              variant="outline" 
              size="sm" 
              className="text-xs flex items-center gap-1 text-muted-foreground hover:bg-primary/10"
  ...
  async function handleGoogleSignIn() {
    try {
      ...
      if (errorMessage.includes('not authorized')) {
        // Display the Firebase setup instructions for more detailed help
        setTimeout(() => {
          // Small delay to ensure the error message is visible first
          if (confirm("Would you like to see detailed domain setup instructions?")) {
